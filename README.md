...
products = [
    ...
    FileProduct(["lib/libiodbcinst.2.dylib.dSYM/Contents/Resources/DWARF/libiodbcinst.2.dylib"], :libiodbcinstdSYM),
    LibraryProduct(["libiodbcinst"], :libiodbcinst),
    ExecutableProduct(["iodbctest"], :iodbctest),
    ExecutableProduct(["iodbctestw"], :iodbctestw),
    FileProduct(["lib/libiodbc.2.dylib.dSYM/Contents/Resources/DWARF/libiodbc.2.dylib"], :libiodbcdSYM)
]
```
