...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import iODBC_debug_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("f7d3fe37-dbaf-5e02-82a8-8fd103cbf401"))
platforms = [Pkg.Artifacts.unpack_platform(e, "iODBC_debug", artifacts_toml) for e in artifacts["iODBC_debug"]]
...
if best_platform === nothing
    @debug("Unable to load iODBC_debug; unsupported platform $(triplet(platform_key_abi()))")
else
